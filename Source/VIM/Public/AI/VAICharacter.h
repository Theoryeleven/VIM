...
UCLASS(ABSTRACT)
class VIM_API AVAICharacter : public AVBaseCharacter
{
	GENERATED_BODY()
...
protected:
	...
	/* Update the vocal loop of the AI (idle, wandering, hunting) */
	UFUNCTION(Reliable, NetMulticast)
...
public:
	...
	AVAICharacter(const class FObjectInitializer& ObjectInitializer);
	...
	/* The thinking part of the brain, steers our ai and makes decisions based on the data we feed it from the Blackboard */
