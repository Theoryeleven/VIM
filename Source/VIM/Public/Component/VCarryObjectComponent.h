...
#include "VCarryObjectComponent.generated.h"

/**
 * 
 */
UCLASS(ClassGroup = (Survival), meta = (BlueprintSpawnableComponent))
class VIM_API UVCarryObjectComponent : public USpringArmComponent
{
	GENERATED_BODY()

	UVCarryObjectComponent(const FObjectInitializer& ObjectInitializer);
