...
#include "VTimeOfDayManager.h"


AVTimeOfDayManager::AVTimeOfDayManager()
{
...
void AVTimeOfDayManager::BeginPlay()
{
	Super::BeginPlay();
...
void AVTimeOfDayManager::Tick(float DeltaSeconds)
{
	Super::Tick(DeltaSeconds);

	AVGameState* MyGameState = Cast<AVGameState>(GetWorld()->GetGameState());
	if (MyGameState)
	{
...
void AVTimeOfDayManager::UpdateSkylight()
{
	if (SkyLightActor)
	{
		AVGameState* MyGameState = Cast<AVGameState>(GetWorld()->GetGameState());
...
void AVTimeOfDayManager::PlayAmbientLoop()
{
