...
AVExplosionEffect::AVExplosionEffect(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void AVExplosionEffect::BeginPlay()
{
	Super::BeginPlay();
...
void AVExplosionEffect::Tick(float DeltaSeconds)
{
